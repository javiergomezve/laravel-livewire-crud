    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="float-left mt-5">
                <button class="btn btn-success" wire:click="$emit('triggerCreated')">
                    Create new user
                </button>
            </div>

            <div class="float-right mt-5">
                <input type="text" class="form-control" wire:model.debounce.800ms="search" placeholder="Search users...">
            </div>
        </div>
    </div>
